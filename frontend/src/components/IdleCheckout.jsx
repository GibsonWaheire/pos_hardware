...
const TIPS = [
  ...
  'Items with no price set cannot be added to the bill',
  'Void All requires manager authorization',
]

// Hardware-themed SVG path snippets for parallax shapes
const SHAPES = [
  // Bolt / lightning
  { id: 'bolt',   path: 'M13 2L4.5 13.5H11L9 22l10-12.5H13Z',                    dur: 18, x: 8,  y: 5,  r: 12,  size: 64 },
  // Wrench
  { id: 'wrench', path: 'M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z', dur: 24, x: 74, y: 12, r: -25, size: 72 },
  // Pipe / cylinder
  { id: 'pipe',   path: 'M4 10h16v4H4zM6 8v8M18 8v8',                            dur: 31, x: 58, y: 70, r: 45,  size: 60 },
  // Gear / cog
  { id: 'gear',   path: 'M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm0 0v2m0-8V7m5 5h2M7 12H5m8.66 3.54 1.41 1.41M6.34 6.34l1.41 1.41M17.66 6.34l-1.41 1.41M7.76 17.66 6.34 16.24', dur: 22, x: 85, y: 50, r: 0,   size: 68 },
  // Hammer outline
  { id: 'hammer', path: 'M15 5l4 4-9 9-4-4 9-9zM2 22l4-4',                       dur: 28, x: 28, y: 65, r: 0,   size: 58 },
  // Paint tin
  { id: 'tin',    path: 'M5 4h14a1 1 0 0 1 1 1v3H4V5a1 1 0 0 1 1-1zM4 8h16v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8z', dur: 19, x: 44, y: 22, r: 8,   size: 56 },
]
...
export default function IdleCheckout({ visible, storeConfig = {}, dailyTotals }) {
  ...
  const slides = [
    ...
    <div key="welcome" className="idle-slide-content">
      ...
      <div className="idle-hint">Ready to serve — scan a barcode or search</div>
    </div>,
  ...
  return (
    <div className={`idle-checkout${fadeIn ? ' idle-fade-in' : ''}`} aria-hidden="true">
      {/* Layer 1 — floating hardware silhouettes (parallax feel via varying animation durations) */}
      <div className="idle-parallax">
        {SHAPES.map(s => (
          <svg
            ...
            width={s.size}
            height={s.size}
            style={{ left: `${s.x}%`, top: `${s.y}%`, animationDuration: `${s.dur}s`, transform: `rotate(${s.r}deg)` }}
            fill="none"
            stroke="currentColor"
            strokeWidth="1"
            strokeLinecap="round"
