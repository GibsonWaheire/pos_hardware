    ...
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="page-body" style={{ flex: 1, overflow: 'auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          ...
          <Link to="/staff" className="btn btn-primary">Manage Staff</Link>
        </div>
        <div className="card" style={{ marginBottom: 24, color: 'var(--text-muted)', fontSize: 13 }}>
          Staff management has moved to the dedicated Staff page — add, edit, deactivate, and view activity logs there.
        </div>
